...
== Machinetalk Requirements & Technologies
This is derived from Alexander Rössler's (aka the “Machine Koder”)
Machinetalk explained series describing the concepts and ideas behind
the Machinetalk middleware.
Specifically,
link:http://machinekoder.com/machinetalk-explained-part-2-middleware-requirements/[Machinetalk explained Part 2: Middleware Requirements]
and link:http://machinekoder.com/machinetalk-explained-part-3-technologies/[Machinetalk explained Part 3: Technologies].

More detail is here
link:../code/Machinetalk_Requirements_Technologies[MT Requirements & Technologies]
